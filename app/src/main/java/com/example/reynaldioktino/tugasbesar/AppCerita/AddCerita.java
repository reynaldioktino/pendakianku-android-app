...
public class AddCerita extends AppCompatActivity {

    Context mContext;
    ImageView mImageView;
    Button btAddPhotoId, btAddBack, btAddData;
    EditText edtAddIdCerita, edtAddNamaGunung, edtAddCerita;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_cerita);
        mContext = getApplicationContext();
        mImageView = (ImageView) findViewById(R.id.imgAddPhotoId);
        btAddPhotoId = (Button) findViewById(R.id.btAddPhotoId);
        edtAddIdCerita = (EditText) findViewById(R.id.edtAddIdCerita);
        edtAddNamaGunung = (EditText) findViewById(R.id.edtAddNamaGunung);
        edtAddCerita = (EditText) findViewById(R.id.edtAddCerita);
            ...
            public void onClick(View view) {
                ...
                RequestBody reqIdCerita =
                        MultipartBody.create(MediaType.parse("multipart/form-data"),
                                ...
                                (edtAddIdCerita.getText().toString().isEmpty()==true)?"":edtAddIdCerita.getText().toString());

                RequestBody reqNamaGunung =
                        MultipartBody.create(MediaType.parse("multipart/form-data"),

                                (edtAddNamaGunung.getText().toString().isEmpty())?"":edtAddNamaGunung.getText().toString());
                RequestBody reqCerita =
                        MultipartBody.create(MediaType.parse("multipart/form-data"),

                                (edtAddCerita.getText().toString().isEmpty())?"":edtAddCerita.getText().toString());
                RequestBody reqAction =
                        MultipartBody.create(MediaType.parse("multipart/form-data"),
                                "post");
                Call<ResultCerita> mCeritaCall =
                        mApiInterface.postCerita(body, reqIdCerita, reqNamaGunung, reqCerita, reqAction );
...
//                                t.getMessage());
        ...
        btAddBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(mContext, Cerita.class);
